...
export const IconZoomIn = () => (
  <svg width="32" height="32" className="QiJdx" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
    <path d="M22 12h4.8v2.7h-9.5V5.2H20V10l6.1-6L28 5.9 22 12zM5.2 20H10l-6 6.1L5.9 28l6.1-6v4.8h2.7v-9.5H5.2V20z" />
  </svg>
);
